        ...
        <div className='container'>
            <div className='row p-5 mt-5 mb-5'>
                ...
                <div className='col-4 p-5 mt-2 mb-2'>
                    ...
                    <a href='' style={{ textDecoration: "none", lineHeight:"2.5"}}>Marginleverage, Product and Order types</a>
                    <br />
                    ...
                    <br />
                    <a href='' style={{ textDecoration: "none", lineHeight:"2.5"  }}>Sentinal </a>
                    <br />
                ...
                <div className='col-4 p-5 mt-2 mb-2'>
                    ...
                    <br />
                    <a href='' style={{ textDecoration: "none", lineHeight:"2.5"  }}>Fund Withdraw</a>
                    <br />
                ...
                <div className='col-4 p-5 mt-2 mb-2'>
                    ...
                    <br />
                    <a href='' style={{ textDecoration: "none", lineHeight:"2.5"  }}>Government Security</a>
                </div>
            </div>
        </div>
    );
