            ...
            <div className='container border-top mt-5' >
                <div className='row mt-5'>
                    <div className='col'>
                        ...
                        <div style={{ display: "flex", flexDirection: "column", gap: "15px", maxWidth: "200px" }}>
                            {/* First Row (First 4 icons) */}
                            <div style={{ display: "flex", gap: "15px", alignItems: "center", fontSize: "30px" }}>
                            ...
                            <hr style={{
                                border: "none",
                                height: "2px",
                                backgroundColor: "#333", /* Dark gray/black - change to #fff if your background is dark */
                                margin: "5px 0",
                                width: "100%"
                            }} />

                            {/* Second Row (Last 3 icons) */}
                            <div style={{ display: "flex", gap: "15px", alignItems: "center", fontSize: "30px" }}>
